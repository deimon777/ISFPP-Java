...
public class Camino {
	...
	private Vertice ciudad_inicio = null;
	private Vertice ciudad_fin = null;
	...
	public void setCiudadInicio(Vertice ciudad) {
		this.ciudad_inicio = ciudad;
	}

	public Vertice getCiudadFin() {
		return ciudad_fin;
	}
	public void setCiudadFin(Vertice ciudad) {
