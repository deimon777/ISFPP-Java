...
public class JFX_ModificarCiudad extends Pane{
	VBox panel = new VBox();

	public JFX_ModificarCiudad(int nId, String nNombre, int nHabitantes, String nHistoria, double nLatitud, double nLongitud, boolean nActivo) {
		...
		btn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				if(valido){
					...
					new Main<VBox>().cambiarVista(new JFX_VerCiudad().getPanel());
				}
				output.setOpacity(1);
			}
		});
